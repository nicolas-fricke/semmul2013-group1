...
\begin{figure}[!htb]
  \minipage{0.49\textwidth}
    ...
    \caption{Overview of the web interface (1) search term entered by user (2) semantic hierarchy (3) each line represents one node of the entered search term with associated images}\label{fig_webinerface_1}
  \endminipage\hfill
  \minipage{0.49\textwidth}
    \includegraphics[width=\linewidth]{images/webfrontend-screenshot_2.pdf}
    \caption{Details view for one node (1) selected node with definition (2) dark cyan background groups different semantic clusters (3) white background groups visual clusters}\label{fig_webinerface_2}
  \endminipage\hfill
\end{figure}

\todo{could be more comprehensive for chapter 1}
...
Subordinate terms of each node will then be rendered as sub nodes.
This continues, until no more subordinate terms can be found.
...
By clicking on the images of one node it shows the \emph{details view} (Figure \ref{fig_webinerface_2}), where the definition of the particular subordinate term can be found (\ref{fig_webinerface_2}.1).
...
Within the semantic clusters, the white containers group visually similar images (\ref{fig_webinerface_2}.3). 
