...
We built a tool which creates a search tree containing hyponyms \index{Hyponym} and meronyms\index{Meronym} for a given search term and groups matching images into semantically and visually similar clusters.
