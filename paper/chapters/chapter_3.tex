...
Compared to WordNet, DBpedia contains more information in terms of entities, relationships, and attributes, and has support for multiple languages. not as well-structured and consistent, more information but strongly varying levels of detail.
