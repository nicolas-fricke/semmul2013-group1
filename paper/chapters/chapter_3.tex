...
We define the strength of a co-occurrence based on term frequency and inverse document frequency (tf-idf) \index{Tf-idf} values. The term frequency describes a normalized frequency of a term $t_i$ in a document $d_i$:
