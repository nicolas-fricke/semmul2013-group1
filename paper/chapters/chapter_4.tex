...
With the applied pyramid technique, the final feature vector is concatenated from several partial feature vectors. The image is first analyzed as a whole, than the top half, the bottom half, left half and right half, followed by horizontal and vertical thirds etc. up to splitting each picture in five parts. 

\begin{figure}[h]
\centering
\includegraphics[width=0.09\textwidth]{images/partitioning5h.pdf}
\includegraphics[width=0.09\textwidth]{images/partitioning5v.pdf}
\includegraphics[width=0.09\textwidth]{images/partitioning4h.pdf}
\includegraphics[width=0.09\textwidth]{images/partitioning4v.pdf}
\includegraphics[width=0.09\textwidth]{images/partitioning3h.pdf}
\includegraphics[width=0.09\textwidth]{images/partitioning3v.pdf}
\includegraphics[width=0.09\textwidth]{images/partitioning2h.pdf}
\includegraphics[width=0.09\textwidth]{images/partitioning2v.pdf}
\includegraphics[width=0.09\textwidth]{images/partitioning1h.pdf}
\includegraphics[width=0.09\textwidth]{images/partitioning1v.pdf}

\caption{Two images that have the same color histogram regarding the entire picture but different histograms on the marked regions}
\label{fig_blackwhite}
\end{figure}

\cite{Lazebnik2006} also states the appropriateness of this method especially in refining existing clusters.\\
